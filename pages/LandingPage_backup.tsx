  ...
  return (
    <div className="medly-landing">
          ...
          <div className="hero-container">
            <div className="hero-content">
              ...
              <p className="subtitle">
                Medly helps you privately capture symptoms, track health patterns, and generate
      ...
      <section className="data-flow-section scroll-animate">
        <div className="container">
          <h2 className="section-title">How Medly Works</h2>
      ...
      <section id="capabilities">
        <div className="container">
          <h2 className="section-title">What Medly helps you do</h2>
